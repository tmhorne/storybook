...
public abstract class AbstractDemo extends AbstractTest {
	...
	protected static Scene makeScene(Calendar cal, Chapter chapter,
			Strand strand, String title, String summary) throws Exception {
		return makeScene(cal, chapter, strand, title, summary,
				Scene.Status.DONE.ordinal());
	}

	protected static Scene makeScene(Calendar cal, Chapter chapter,
			Strand strand, String title, String summary, int status)
			throws Exception {
		++sceneCounter;
	...
	protected static void makeLocationLink(Scene scene, Location location)
			throws Exception {
	...
	protected static void makeTagLink(Tag tag, Location location)
			throws Exception {
	...
	protected static void makeTagLink(Tag tag, SbCharacter character)
			throws Exception {
		TagLink lnk = new TagLink();
		lnk.setTag(tag);
	...
	protected static void makeTagLink(Tag tag, SbCharacter character,
			Scene startScene) throws Exception {
		makeTagLink(tag, character, startScene, null);
	}

	protected static void makeTagLink(Tag tag, SbCharacter character,
			Scene startScene, Scene endScene) throws Exception {
		TagLink lnk = new TagLink();
		lnk.setTag(tag);
		lnk.setCharacter(character);
	...
	protected static void makeTagLink(Tag tag, Scene startScene,
			Scene endScene) throws Exception {
		TagLink lnk = new TagLink();
		lnk.setTag(tag);
		lnk.setStartScene(startScene);
		lnk.setEndScene(endScene);
	...
	protected static void makeCharacterLink(Scene scene, SbCharacter character)
			throws Exception {
	...
	protected static void makeStrandLink(Scene scene, Strand strand)
			throws Exception {
	...
	protected static Tag makeTag(String name, String category, String descr)
			throws Exception {
		Tag tag = new Tag();
	...
	protected static Item makeItem(String name, String category, String descr)
			throws Exception {
		Item item = new Item();
	...
	protected static Location makeLocation(String name, String city,
			String country, String descr) throws Exception {
	...
	protected static SbCharacter makeCharacter(String firstname,
			String lastname, String abbreviation, String description,
			Gender gender, String birthdayStr) throws Exception {
		return makeCharacter(firstname, lastname, abbreviation, description,
				gender, birthdayStr, null, true);
	}

	protected static SbCharacter makeCharacter(String firstname,
			String lastname, String abbreviation, String description,
			Gender gender, String birthdayStr, Color color, boolean central)
			throws Exception {
	...
	protected static Gender makeGender(String name, int childhood,
			int adolescence, int adulthood, int retirement) throws Exception {

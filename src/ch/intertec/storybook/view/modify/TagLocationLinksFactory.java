...
public class TagLocationLinksFactory extends AbstractLinksFactory {

	public TagLocationLinksFactory(List<Object> linksList, DbTable table) {
	...
	public List<? extends DbTable> doSelectByLocation(Location location) {
		...
		List<TagLink> linkList = TagLinkPeer.doSelectByLocationId(location.getId());

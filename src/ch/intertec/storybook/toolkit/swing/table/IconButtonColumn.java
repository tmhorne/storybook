...
public class IconButtonColumn extends AbstractCellEditor implements
	...
	private IconButton renderButton;
	 ...
	 */
	public IconButtonColumn(JTable table, Action action, int column,
			String resourceIcon, String tooltip) {
		this.table = table;
		this.action = action;

		renderButton = new IconButton(resourceIcon);
		renderButton.setSize16x16();
		renderButton.setToolTipText(I18N.getMsg(tooltip));
		editButton = new IconButton(resourceIcon);
		editButton.addActionListener(this);
		editButton.setToolTipText(I18N.getMsg(tooltip));
		editButton.setSize16x16();
